...
public class Tmassproject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(130, 0, 400, 60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tmassproject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tmassproject().setVisible(true);
            }
        });
    }
